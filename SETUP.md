...
При нажатии «Реферальная программа» пользователь получает персональную ссылку вида `https://t.me/your_bot?start=ref_12345`. Когда приглашённый друг оплатит тариф, рефереру автоматически добавляется указанное количество дней к подписке в Remnawave.
